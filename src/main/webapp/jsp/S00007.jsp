						...
						<td class="label" rowspan=2 >ニックネーム</td>
							<td class="value">
								<table class="radio_base">
									<tr>
										<td>
											<input type="radio" name="nickname_radio" value="1" class="onOffRadio" <%=nickname_radio1 %>><span class="radio_label">指定</span>
										</td>
											<td>
												<input type="radio" name="nickname_radio" value="2" class="onOffRadio" <%=nickname_radio2 %>><span class="radio_label">指定なし</span>
											</td>
										</tr>
									</table>
								</td>
								...
								<tr>
									<td class="value">
										<table class="radio_base">
											<tr>
												<td>
													<input type="radio" name="nickname_type_radio" value="1" <%=nickname_type_radio1 %>><span class="radio_label">あいまい</span>
												</td>
											<td>
												<input type="radio" name="nickname_type_radio" value="2" <%=nickname_type_radio2 %>><span class="radio_label">完全一致</span>
											</td>
										</tr>
									</table>
		...
		<!--登録日-->
	      <div class="input_table">
	        <table>
	          <tr>
	            ...
	            <td class="value">
	              <table class="radio_base">
	                <tr>
	                  <td>
	                    <input type="radio" name="joined_date_radio" value="1" class="onOffRadio" <%=joined_date_radio1 %>><span class="radio_label">指定</span>
	                  </td>
	                  <td>
	                    <input type="radio" name="joined_date_radio" value="2" class="onOffRadio" <%=joined_date_radio2 %>><span class="radio_label">指定なし</span>
	                  </td>
	                </tr>
	              </table>
	            </td>
	          ...
	          <tr>
	            <td class="value">
	              <input type="date" name="joined_date_from" value= <%=joined_date_from%>>
	              <br/>
	              <div class="left_padding1">
	              ≀
	              </div>
	              <input type="date" name="joined_date_to" value= <%=joined_date_to%>>
	            </td>
	          </tr>
	        </table>
	      </div>
					...
					<td class="label" rowspan=2 >性別</td>
						<td class="value">
							<table class="radio_base">
								<tr>
									<td>
										<input type="radio" name="gender_radio" value="1" class="onOffRadio" <%=gender_radio1 %>><span class="radio_label">指定</span>
									</td>
									<td>
										<input type="radio" name="gender_radio" value="2" class="onOffRadio" <%=gender_radio2 %>><span class="radio_label">指定なし</span>
									</td>
								</tr>
							</table>
						</td>
						...
						<td class="label" rowspan=2 >誕生日</td>
							<td class="value">
								<table class="radio_base">
									<tr>
										<td>
											<input type="radio" name="birthday_radio" value="1" class="onOffRadio" <%=birthday_radio1 %>><span class="radio_label">指定</span>
										</td>
											<td>
												<input type="radio" name="birthday_radio" value="2" class="onOffRadio" <%=birthday_radio2 %>><span class="radio_label">指定なし</span>
											</td>
										</tr>
									</table>
								</td>
								...
								<tr>
									<td class="value">
										<input type="date" name="birthday_from" value=<%=birthday_from %>>
									<br/>
										<div class="left_padding1">
											≀
										</div>
											<input type="date" name="birthday_to" value=<%=birthday_to %>>
										</td>
									</tr>
								</table>
							</div>
					...
					<td class="label" rowspan=2 >リスナー数</td>
						<td class="value">
							<table class="radio_base">
								<tr>
									<td>
										<input type="radio" name="listener_count_radio" value="1" class="onOffRadio" <%=listener_count_radio1 %>><span class="radio_label">指定</span>
									</td>
										<td>
											<input type="radio" name="listener_count_radio" value="2" class="onOffRadio" <%=listener_count_radio2 %>><span class="radio_label">指定なし</span>
										</td>
									</tr>
								</table>
							</td>
							...
							<tr>
								<td class="value">
									<input type="text" name="listener_count_from" value=<%= listener_count_from%>>
								<br/>
									<div class="left_padding2">
										≀
									</div>
										<input type="text" name="listener_count_to" value=<%= listener_count_to%>>
									</td>
								</tr>
							</table>
						</div>
						...
						<td class="label" rowspan=2 >言語</td>
							<td class="value">
								<table class="radio_base">
									<tr>
										<td>
											<input type="checkbox" name="language_type_jp"  value="002" class="onOffRadio" <%=language_type_jp %>><span class="radio_label">日本語</span>
												<br>
											<input type="checkbox" name="language_type_en"  value="001" class="onOffRadio"  <%=language_type_en %>><span class="radio_label">英語</span>
										</td>
									</tr>
								</table>
							</td>
